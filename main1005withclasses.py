...
class MachineLearning:
    ...
    def result_test(self):
        ...
        x_train, x_test, y_train, y_test = train_test_split(df_test['text'], labels_test, test_size=form_test_size, random_state=7)
...
"color: rgb(0, 115, 255);")
        ...
        machineLearning = MachineLearning(self.doubleSpinBoxSizeTestSet, self.doubleSpinBoxMaxDF, self.spinBox,
                 self.label_accuracy, self.label_predskazano_pravilno, self.label_pravilno_count_true_result,
                 ...
                 self.label_9,self.label_3,self.label_result)
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.label_result.setText(_translate("MainWindow", "FAKE"))
        ...
        #self.label_pravilno_count_true_result.setText(_translate("MainWindow", "500 TRUE-результатов"))
        #self.label_pravilno_count_fake_result.setText(_translate("MainWindow", "500 FAKE-результатов"))
        #self.label_neverno_count_true_result.setText(_translate("MainWindow", "50 TRUE-результатов"))
        self.label_predskazano_neverno.setText(_translate("MainWindow", "Классифицировано неверно:"))
        #self.label_neverno_count_fake_result.setText(_translate("MainWindow", "50 FAKE-результатов"))
