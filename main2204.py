...
#название не распознаватель фейковых новостей
#добавить отдельную вкладку "исследования" например окно и график
...
"color: rgb(84, 103, 118);")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 561, 571))
