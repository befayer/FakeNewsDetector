...
class Ui_Login(object):
    ...
    def show_main(self):
        self.pushButton.clicked.connect(lambda: self.showww())

    def event_regitration(self):
        self.pushButton_2.clicked.connect(lambda: self.regitration())
